...
#
#
#### Plot of the SIR model under which ABC simulations will be performed
...
legend("topleft", legend=c("S", "Prev", "R","CumInc", "Inc"),col=c("blue4","orange",
       "green","purple","red"), pch = 19, cex = 0.65,bg=8 )
