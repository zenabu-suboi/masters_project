...
ABC_rej1$computime
plot(ABC_rej1$param[, 1], ABC_rej1$param[, 2], main="ABC_rejection, beta=0.2, gamma=0.02, tolerance = 1")
...
nreprej= 10000
#tolp= 0.5 # retaining all results
set.seed(234)
...
ABC_rej2$computime
plot(ABC_rej2$param[, 1], ABC_rej2$param[, 2], main="ABC_rejection, beta=0.3, gamma=0.02, tolerance = 1")
...
ABC_rej3$computime
plot(ABC_rej3$param[, 1], ABC_rej3$param[, 2], main="ABC_rejection, beta=0.5, gamma=0.025, tolerance =1")
...
ABC_rej4$computime
plot(ABC_rej4$param[, 1], ABC_rej4$param[, 2], main="ABC_rejection, beta=0.2, gamma=0.05, tolerance = 1")
...
ABC_rej5$computime
plot(ABC_rej5$param[, 1], ABC_rej5$param[, 2], main="ABC_rejection, beta=0.4, gamma=0.025, tolerance =1")
...
ABC_rej6$computime
plot(ABC_rej6$param[, 1], ABC_rej6$param[, 2], main="ABC_rejection, beta=0.5, gamma=0.04, tolerance = 1")
...
par(mfrow=c(3,2))
plot(ABC_rej1$param[, 1], ABC_rej1$param[, 2], main="ABC_rejection, beta=0.2, gamma=0.02, tolerance = 0.05")
plot(ABC_rej2$param[, 1], ABC_rej2$param[, 2], main="ABC_rejection, beta=0.3, gamma=0.02, tolerance = 0.05")
plot(ABC_rej3$param[, 1], ABC_rej3$param[, 2], main="ABC_rejection, beta=0.5, gamma=0.025, tolerance = 0.05")
plot(ABC_rej4$param[, 1], ABC_rej4$param[, 2], main="ABC_rejection, beta=0.2, gamma=0.05, tolerance = 0.05")
plot(ABC_rej5$param[, 1], ABC_rej5$param[, 2], main="ABC_rejection, beta=0.4, gamma=0.025, tolerance = 0.05")
plot(ABC_rej6$param[, 1], ABC_rej6$param[, 2], main="ABC_rejection, beta=0.5, gamma=0.04, tolerance = 0.05")
